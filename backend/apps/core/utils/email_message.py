...
def send_voter_email(voter, election_title):
    ...
    message = f"""Hello {voter.full_name},\n
                ...
                This code will expire in 12 hours.""" # Expiration time to be rendered dynamically
    send_mail(
        subject, 
        message,
...
def assign_voter_code(voter, election_title, expiration_time=None):
    ...
    voter.save()
    send_voter_email(voter, election_title)